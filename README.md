...
+ **[Как сгенерить большую строку, инструменты](http://okiseleva.blogspot.ru/2015/08/blog-post_8.html)**: Для поиска граничных значений нужна возможность генерить строку большого размера. Больше символов богу символов! Приложение может зависнуть, если вбить туда 1000000000000 символов, но как их сгенерить?  
